...
.links {
    text-align: center;
    margin-top: 10px; /* Tambahkan jarak di bagian atas */
}
...
<body>
  ...
  <section>
    <span></span> <!-- Add your animated background spans here -->
    <!-- ... other spans ... -->
      ...
      <div class="content">
        ...
        <div class="form">
          <form autocomplete="off" action="" method="POST">
            <!-- Adjust the action attribute to the actual PHP file that processes the login -->
            <div class="inputBox">
            ...
            <div class="links">
              ...
              <a href="signup.php">Sign Up</a> <!-- Link to your sign-up page -->
            </div>
            <div class="inputBox">
